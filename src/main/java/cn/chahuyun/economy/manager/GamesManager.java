...
public class GamesManager {
    ...
    public static void fishing(MessageEvent event) {
         ...
         * 收杆时- 增加buff
         * ddd:
         * 等级的话跟之前一样，就是rodlevel÷9，小于等于这个值的，随机一个等级
         *
         * ddd:
         * 等级确定完了，根据难度系数判断特殊鱼：
         * 每个等级内有非1的难度系数，这些特殊鱼优先计算：
         * 概率=系数/2×(rodlevel/161)×π/10（这个概率的精度需要在小数点后5位）
         *
         * 根据以上概率，判断本次是否roll中特殊鱼，如果所有优先计算的鱼都没roll中，则在该等级的剩下的鱼里正常随机。
         *
         *
         */
